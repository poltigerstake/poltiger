...
const link = "https://poltiger.github.io/poltiger/?ref=" + us;
...
{
	procuser = 5.0;
} else if(getUserTotalDeposits >= 100 && getUserTotalDeposits <199)
{
	procuser = 5.0;
} else if(getUserTotalDeposits >= 200 && getUserTotalDeposits <499)
{
	procuser = 5.0;
}
